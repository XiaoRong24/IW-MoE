...
def mesh2flow(mesh, name='Mesh2Flow', **kwargs):
    ...
    def _transform3(theta):
        ...
        flow = torch.stack([flow_x, flow_y], dim=1)  # stack along the second dimension
        flow = flow.view(num_batch, height, width, 2)  # reshape to [num_batch, height, width, 2]
